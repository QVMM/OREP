...
def _run_cloud_complete_recording_asr(wav_path: str, duration: float) -> dict:
...
def _run_authoritative_asr(
    ...
    *,
    ...
    if not settings.LOCAL_SPEAKER_DIARIZATION_ENABLED:
        return _run_cloud_complete_recording_asr(wav_path, duration)
    ...
    branches = {
        "cloud_asr": lambda: _run_cloud_complete_recording_asr(wav_path, duration),
