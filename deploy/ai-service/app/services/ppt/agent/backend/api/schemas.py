...
class ModelConfig(BaseModel):
    provider: str  # "mimo", "qwen", "openai", "deepseek", "anthropic", "gemini"
    model: str
    api_key: str
...
class ResearchConfig(BaseModel):
    ...
    web_search_provider: Literal["mimo", "tavily", "serpapi"] = "mimo"
...
class JobStatus(BaseModel):
    ...
    error: str | None = None
    # Recovery hints (P1): clients can show 从中断继续 / 重新生成 without guessing.
