...
async def update_svg_fonts(job_id: str, payload: UpdateFontsRequest, request: Request) -> UpdateFontsResponse:
    ...
    config = FontReplaceConfig(
        western_heading=payload.western_heading,
        western_body=payload.western_body,
        cjk_heading=payload.cjk_heading,
        cjk_body=payload.cjk_body,
    )
