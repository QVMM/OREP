              ...
              <div className="options-icon-sub">
                <div className="research-provider-select">
                  <Button
                    type="button"
                    size="sm"
                    variant={(props.researchConfig.web_search_provider ?? "mimo") === "mimo" ? "default" : "outline"}
                  ...
                  >
                    {t("options.mimoWebSearch")}
                  </Button>
                  <Button
                    type="button"
                    size="sm"
                    variant={props.researchConfig.web_search_provider === "tavily" ? "default" : "outline"}
                    className="research-provider-button"
                    onClick={() => {
                      props.onResearchConfigChange({
                        ...props.researchConfig,
                ...
                {(props.researchConfig.web_search_provider ?? "mimo") === "mimo" ? (
                  <p className="research-warning">
                    <FlaskConical size={11} style={{ marginRight: 4, verticalAlign: "middle" }} />
                    {t("options.mimoWebSearchServerKey")}
                  </p>
                ) : props.researchConfig.web_search_provider === "tavily" ? (
                  <label className="form-field options-api-key-field">
                    <span>
                      <Key size={12} style={{ marginRight: 4, verticalAlign: "middle" }} />
                      {t("options.tavilyApiKey")}
                ...
                {(props.researchConfig.web_search_provider === "tavily" && !props.researchConfig.tavily_api_key) ||
