...
from .endpoints import download, font_update, generate, history, image_search, preview, providers, refine, roadshow_plan, session, status, template_import, templates, upload, usage, versions
...
api_router.include_router(roadshow_plan.router, tags=["roadshow-plan"])
